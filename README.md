...
This repository contains R scripts and supporting files for my MSc project conducted at University College London. The project focused on analysing **correlation structures of DNA methylation** across various tissues and ethnic groups.
